...
$clientId = "f74fb3f0-0c9f-410a-b0e0-d4e556265672"
$credentials = Get-Credential -UserName $clientId
$postParams = @{grant_type='client_credentials';client_id=$clientId;
client_secret=$credentials.GetNetworkCredential().Password;resource='https://management.core.windows.net'}
